...
const labels: Record<string, string> = { '/': '今日总览', '/tasks': '任务与 GTD', '/calendar': '本地日历', '/habits': '习惯与喝水', '/notes': '笔记', '/prompts': '提示词模板', '/files': '文件索引', '/reports': '统计周报', '/settings': '设置' };
const icons: Record<string, string> = { '/': '◈', '/tasks': '✓', '/calendar': '▦', '/habits': '◉', '/notes': '▤', '/prompts': '⌘', '/files': '▱', '/reports': '◫', '/settings': '⚙' };
